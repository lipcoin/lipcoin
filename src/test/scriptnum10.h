...
#ifndef LIPCOIN_TEST_SCRIPTNUM10_H
#define LIPCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from LipCoin Core 0.10.0, for cross-comparison.
 */
public:
