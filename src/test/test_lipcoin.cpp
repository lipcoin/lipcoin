...
#define BOOST_TEST_MODULE LipCoin Test Suite

#include "test_lipcoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_lipcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
