...
// Copyright (c) 2009-2013 The LipCoin developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LIPCOIN_BIGNUM_H
#define LIPCOIN_BIGNUM_H
...
public:
    ...
    //
    // LipCoin only uses this "compact" format for encoding difficulty
