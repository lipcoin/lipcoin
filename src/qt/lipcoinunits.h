...
#ifndef LIPCOIN_QT_LIPCOINUNITS_H
#define LIPCOIN_QT_LIPCOINUNITS_H
...
/** LipCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LipCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LipCoinUnits(QObject *parent);

    /** LipCoin units.
      @note Source: https://en.lipcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LIPC,
...
typedef LipCoinUnits::Unit LipCoinUnit;

#endif // LIPCOIN_QT_LIPCOINUNITS_H
