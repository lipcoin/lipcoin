...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lipcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lipcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lipcoin transaction") + "\n" +
              "  lipcoin-tx [options] -create [commands]   " + _("Create hex-encoded lipcoin transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CLipCoinAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CLipCoinAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lipcoin transaction
