...
unlocked to sign the LipCoin-Qt.app bundle.
...
allowing somebody to distribute a LipCoin-Qt.app or lipcoin-qt-setup.exe with a valid
...
that the lipcoin-qt.exe file inside the installer had not been tampered with.
