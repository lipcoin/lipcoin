...
class RawTransactionsTest(LipCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid lipcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid lipcoin address" in e.error['message'])
