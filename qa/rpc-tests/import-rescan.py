...
import RPC call and node 0 sends LIPC to it. Then other nodes import the
...
In the second part of the test, node 0 sends more LIPC to each address, and the
...
class ImportRescanTest(LipCoinTestFramework):
    def __init__(self):
        super().__init__()
