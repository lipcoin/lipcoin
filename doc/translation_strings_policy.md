...
This document provides guidelines for internationalization of the LipCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lipcoin_en.ts` remains unchanged.
